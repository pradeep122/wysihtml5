...
6:"wysiwyg-font-size-xx-large",7:"wysiwyg-font-size-xx-large","-":"wysiwyg-font-size-smaller","+":"wysiwyg-font-size-larger"};return function(b){return a[String(b).charAt(0)]}}(),font_family:function(){var a={tahoma:"wysiwyg-font-family-tahoma",verdana:"wysiwyg-font-family-verdana",impact:"wysiwyg-font-family-impact",times:"wysiwyg-font-family-times",monospace:"wysiwyg-font-family-monospace"};return function(b){return a[String(b).toLowerCase()]}}()};return function(b,c,d,e){wysihtml5.lang.object(g).merge(f).merge(c).get();
